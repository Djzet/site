...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        # Get second page and confirm it has (exactly) remaining 20 items
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Создание 6 объектов BookInstance
        number_of_book_copies = 6
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        # Подтверждение, что из всего списка показывается только 3 экземпляров
